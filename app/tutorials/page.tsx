        ...
        <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
            ...
            <Collapse accordion>
                ...
                <Panel header="What happens if I forget to log out?" key="7">
                    <Paragraph>
                        If you're inactive for a while, your status may automatically switch to offline. However, you can always manually log out from the profile menu. Logging out ensures your session is secure, especially on shared devices.
                    </Paragraph>
                </Panel>
            </Collapse>
